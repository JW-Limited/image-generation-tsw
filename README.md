...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/image-generation-tsw
```

A live public deployment of this template is available at [https://image-generation-tsw.templates.workers.dev](https://image-generation-tsw.templates.workers.dev)
